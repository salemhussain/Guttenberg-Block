	...
	function wpe_archive_views() {
		...
		<div class="wpe-select-view">
			...
			if( isset( $wpe_display_settings['list_view'] ) ) {
				?>
				<span id="wpe-select-list" class="<?php echo $default_view === 'list' ? 'current-menu-item' : '' ?>"><a title="List View" href="#"><span class="dashicons dashicons-list-view"></span></a></span>
				<?php
			} 
			if( isset( $wpe_display_settings['grid_view'] ) ) {
				?>
				<span id="wpe-select-grid" class="<?php echo $default_view === 'grid' ? 'current-menu-item' : '' ?>"><a title="Grid View" href="#"><span class="dashicons dashicons-grid-view"></span></a></span>
				<?php
			}
			if( isset( $wpe_display_settings['cal_view'] ) ) {
				?>
				<span id="wpe-select-calendar" class="<?php echo $default_view === 'calendar' ? 'current-menu-item' : '' ?>"><a title="Calendar View" href="#"><span class="dashicons dashicons-calendar-alt"></span></a></span>
				<?php
			} 
			?>
		</div>
